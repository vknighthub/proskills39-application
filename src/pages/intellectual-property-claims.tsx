...
const IntellectualPropertyClaims: NextPageWithLayout = (props: Props) => {
    return (
        <>
...
IntellectualPropertyClaims.getLayout = function getLayout(page) {
    return <Layout>{page}</Layout>
}
export default IntellectualPropertyClaims