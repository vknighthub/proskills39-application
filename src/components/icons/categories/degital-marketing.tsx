export const DigitalMarketingIcon: React.FC<React.SVGAttributes<{}>> = (props) => {
    return (
        <svg
            viewBox="0 0 64 64"
            fill="none"
