...
import { featuredMoileUserProfile } from '@/components/styles/sliderProps';
...
const MobileServiceTopAvargage = ({ data }: PageProps) => {
    return (
        <>

            <Swiper {...featuredMoileUserProfile} className="featured-carouselmain">
                                            ...
                                            <div className="featured-item-wrapper newest-service">
                                                <div className="featured-item-content">
                                                    <div className="featured-item-image">
                                                        <Image src={value.overviews.files[0]?.url ? value.overviews.files[0].url : newest} alt="Service"
                                                            width={350}
                                                            height={162}
                                                        />
                                                    </div>
...
export default MobileServiceTopAvargage