...
function UnAuthorizedView() {
  ...
  return (
    <div className="relative flex min-h-full flex-col items-center justify-center overflow-hidden py-5 px-4 md:py-8">
      ...
      >
        <LongArrowIcon className="h-4 w-4 rtl:order-1" />
      </Button>
      <div className="relative mx-auto w-full max-w-[445px] overflow-hidden rounded-lg bg-light pb-2 dark:bg-dark-300 lg:max-w-[478px] lg:pb-1"></div>
    </div>
  )
}
